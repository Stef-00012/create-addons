				...
				<h5 className="card-title mb-0">
					...
					{modloaders.includes("fabric") && (
						<>
							...
							/>
							<Tooltip id="fabric-tooltip" disableStyleInjection={true} className="rounded-2xl bg-base-200 px-2 p-1 text-lg shadow-lg" />
						</>
					)}
					{modloaders.includes("forge") && (
						<>
							...
							/>
							<Tooltip id="forge-tooltip" disableStyleInjection={true} className="rounded-2xl bg-base-200 px-2 p-1 text-lg shadow-lg" />
						</>
					)}
					{modloaders.includes("neoforge") && (
						<>
							...
							/>
							<Tooltip id="neoforge-tooltip" disableStyleInjection={true} className="rounded-2xl bg-base-200 px-2 p-1 text-lg shadow-lg" />
						</>
					)}
					{modloaders.includes("quilt") && (
						<>
							...
							/>
							<Tooltip id="quilt-tooltip" disableStyleInjection={true} className="rounded-2xl bg-base-200 px-2 p-1 text-lg shadow-lg" />
						</>
					)}
				</h5>
				<ul>
